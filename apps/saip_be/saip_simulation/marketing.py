...
class SocialMedia(MarketingType):
    ...
    def yield_value(self):
        return (
            self.investment
            * self._calculate_effectivity()
            * MarketingModifiers.SOCIAL_MEDIA_BASE
            * self._bonus_modifier()
        )
    ...
    def _calculate_effectivity_over_minimum(self):
        return (
            ...
            * (self.investment - MarketingInvestments.SOCIAL_MEDIA_MIN)
            / (
                MarketingInvestments.SOCIAL_MEDIA_MAX
                - MarketingInvestments.SOCIAL_MEDIA_MIN
            )
        )
    ...
    def _bonus_modifier(self):
        return (
            1
            + self.investment
            / MarketingInvestments.SOCIAL_MEDIA_STEP
            * MarketingModifiers.SOCIAL_MEDIA_BONUS
        )
    ...
    def _calculate_effectivity_over_minimum(self):
        return (
            ...
            * (self.investment - MarketingInvestments.CABLE_NEWS_MIN)
            / (
                MarketingInvestments.CABLE_NEWS_MAX
                - MarketingInvestments.CABLE_NEWS_MIN
            )
        )
...
class Podcast(MarketingType):
    ...
    def yield_value(self):
        return (
            self.investment * self._calculate_effectivity() * MarketingModifiers.PODCAST
        )
