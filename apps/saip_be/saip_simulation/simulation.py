...
class Simulation:
    ...
    def write_simulation_results(self) -> None:
        ...
        for company_model in ct_companies_states.keys():
            ...
            ct_companies_states[company_model].ret_earnings = company_class_object.balance + company_class_object.next_turn_budget #round((company_class_object.ret_earnings + company_class_object.income_per_turn), 2) #doteraz sales scitane dokopy (? mozno)
