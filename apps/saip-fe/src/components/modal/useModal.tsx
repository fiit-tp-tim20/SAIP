	...
	function Modal() {
		return (
			<div
				...
				} fixed inset-0 z-50 overflow-y-auto top-0 left-0 right-0 bottom-0 bg-[#000000AA] p-4`}
				onClick={() => setIsShowing(false)}
			>
				<div className="flex items-center justify-center min-h-screen">{element}</div>
			</div>
		);
	}
