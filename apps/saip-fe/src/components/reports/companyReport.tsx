							...
							<tbody>
								<tr>
									...
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.production.production} ks
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">Výrobná kapacita (max)</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.production.capacity} ks
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.production.man_cost} €/ks
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">Zásoby</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.production.new_inventory} ks
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">Celkové náklady</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.production.man_cost_all} €/ks
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table className="table-auto">
							...
							<tbody>
								...
								<tr>
									<td className="border px-4 py-2">Zásoby</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.balance.inventory_money} €
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">Kapitálové investície</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.balance.capital_investments} €
									</td>
								</tr>
								<tr>
									...
									<td className="border px-4 py-2 whitespace-nowrap font-bold">
										{data.balance.assets_summary} €
									</td>
								</tr>
							</tbody>
							<thead>
							...
							<tbody>
								...
								<tr>
									<td className="border px-4 py-2">
										Výsledok hospodárenia z predchádzajúcich období
									</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.balance.ret_earnings} €
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">Základné ímanie</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.balance.base_capital} €
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">
									...
									<td className="border px-4 py-2 whitespace-nowrap font-bold">
										{data.balance.liabilities_summary} €
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table className="table-auto">
							...
							<tbody>
								...
								<tr>
									...
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.cash_flow.manufactured_man_cost} €
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td className="border px-4 py-2 whitespace-nowrap">
										<b>{data.cash_flow.cash_flow_result} €</b>
									</td>
								</tr>
						...
						<table className="table-auto">
							<tbody>
								...
								<tr>
									...
									<td className="border px-4 py-2 whitespace-nowrap">
										<b>{data.income_statement.profit_before_tax} €</b>
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">Daň</td>
									<td className="border px-4 py-2 whitespace-nowrap">
										{data.income_statement.tax} €
									</td>
								</tr>
								<tr>
									<td className="border px-4 py-2">
									...
									<td className="border px-4 py-2 whitespace-nowrap">
										<b>{data.income_statement.sales} €</b>
									</td>
								</tr>
							</tbody>
						</table>
